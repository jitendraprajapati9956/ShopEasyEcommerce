          ...
          <div class="panel panel-default">
             ...
             <form class="form-horizontal" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group"> <!-- video 64 start -->
                ...
                <div class="form-group">
                   ...
                   <div class="col-md-6">
                      ...
                      <br><img src="Product Images/<?php echo $p_image1;  ?>" width="70" height="70" >
                   </div>
                </div>
                   <div class="form-group">
                      ...
                      <div class="col-md-6">
                         ...
                         <br><img src="Product Images/<?php echo $p_image2;  ?>" width="70" height="70" >
                      </div>
                   </div>
                      <div class="form-group">
                         ...
                         <div class="col-md-6">
                             ...
                             <br><img src="Product Images/<?php echo $p_image3;  ?>" width="70" height="70" >
                         </div>
                      </div>
                         <div class="form-group">
...
$update_product="update products set p_cat_id='$product_cat',cat_id='$cat_id',date=NOW(),product_title='$product_title',
product_img1='$product_img1',product_img2='$product_img2',product_img3='$product_img3',product_price='$product_price',
product_desc='$product_desc',product_keyword='$product_keyword'  where product_id='$p_id'";

$run_product=mysqli_query($con,$update_product);

if($run_product){
echo "<script>alert('Product has been update successfully')</script>"; 
